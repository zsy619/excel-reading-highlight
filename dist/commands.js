...
/* harmony export */   ensureEnabled: function() { return /* binding */ ensureEnabled; },
/* harmony export */   toggleReadingMode: function() { return /* binding */ toggleReadingMode; }
/* harmony export */ });
/* harmony import */ var _controller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./controller */ "./src/commands/controller.ts");
...
function _toggleReadingMode() {
  _toggleReadingMode = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    var _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          _context.p = 1;
          _context.n = 2;
          return _controller__WEBPACK_IMPORTED_MODULE_0__.controller.toggle();
        case 2:
        ...
        case 3:
          _context.p = 3;
          _t = _context.v;
          console.error("=== RM DIAG: toggleReadingMode FAILED ===", _t);
        case 4:
          return _context.a(2);
      }
    }, _callee, null, [[1, 3]]);
...
function _ensureEnabled() {
  _ensureEnabled = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          _context2.n = 1;
          return _controller__WEBPACK_IMPORTED_MODULE_0__.controller.ensureEnabled();
        case 1:
...
function _clearAll() {
  _clearAll = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          _context3.n = 1;
          return _controller__WEBPACK_IMPORTED_MODULE_0__.controller.clearAll();
        case 1:
...
/* harmony import */ var _shared_ReadingModeCore__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../shared/ReadingModeCore */ "./src/shared/ReadingModeCore.ts");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var AUTO_RESUME_TIMEOUT_MS = 10000;
var AUTO_RESUME_POLL_MS = 200;
Office.onReady(function (info) {
  ...
  Office.actions.associate("clearAll", function () {
    return (0,_commands_excel__WEBPACK_IMPORTED_MODULE_0__.clearAll)();
  });
  if (info && info.host === Office.HostType.Excel) {
    // 上次 enabled=true 才需要等 workbook ready 后自动恢复
    // 否则啥都不做,toggle 留给用户手动触发
    if ((0,_shared_ReadingModeCore__WEBPACK_IMPORTED_MODULE_1__.loadState)().enabled) {
 ...
 */
function autoResumeWhenReady() {
  return _autoResumeWhenReady.apply(this, arguments);
}
function _autoResumeWhenReady() {
  _autoResumeWhenReady = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
    var start, attempt, _loop, _ret;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          start = Date.now();
            ...
            return _regenerator().w(function (_context2) {
              while (1) switch (_context2.p = _context2.n) {
                ...
                case 2:
                  ...
                  console.log("[RM] auto-resume: workbook ready (attempt ".concat(attempt, "), \u8C03 ensureEnabled"));
                  _context2.n = 3;
                  return (0,_commands_excel__WEBPACK_IMPORTED_MODULE_0__.ensureEnabled)();
                case 3:
                  return _context2.a(2, {
                    v: void 0
                  });
                ...
                case 5:
                  ...
                  console.log("[RM] auto-resume: attempt ".concat(attempt, " \u5931\u8D25,\u7EE7\u7EED poll"), _t);
                case 6:
                  _context2.n = 7;
                  return new Promise(function (r) {
                    return setTimeout(r, AUTO_RESUME_POLL_MS);
                  });
                case 7:
                  return _context2.a(2);
              }
        ...
        case 1:
          if (!(Date.now() - start < AUTO_RESUME_TIMEOUT_MS)) {
            _context3.n = 4;
            break;
          }
        ...
        case 3:
          ...
          break;
        case 4:
          console.warn("[RM] auto-resume: \u8D85\u65F6 ".concat(AUTO_RESUME_TIMEOUT_MS, "ms,\u653E\u5F03 ensureEnabled"));
        case 5:
          return _context3.a(2);
      }
    }, _callee2);
